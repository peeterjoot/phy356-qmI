...
%\date{Oct 23, 2010}
%
\makeproblem{ps III.}{problem:qmIproblemSet3:1}{
...
%
\makesubproblem{}{problem:qmIproblemSet3:1:a}
%
What is the group velocity associated with this state?
%
\makesubproblem{}{problem:qmIproblemSet3:1:b}
%
What is the probability for measuring the particle at position \(x=x_0>0\) at time \(t=t_0>0\)?
%
\makesubproblem{}{problem:qmIproblemSet3:1:c}
%
What is the probability per unit length for measuring the particle at position \(x=x_0>0\) at time \(t=t_0>0\)?
%
\makesubproblem{}{problem:qmIproblemSet3:1:d}
%
Explain the physical meaning of the above results.

} % problem
%
\makeanswer{problem:qmIproblemSet3:1}{
%
\makeSubAnswer{Group velocity}{problem:qmIproblemSet3:1:a}
%
...
\end{equation}
%
\makeSubAnswer{Measurement probability}{problem:qmIproblemSet3:1:b}
%
...
\right) \right) \\
&=
\inv{2 \pi} \sqrt{\frac{2 \alpha}{\pi} } \frac{\pi}{\sqrt{\alpha^2 + (t \Hbar/2m)^2 }} \times \\
&\quad
\exp\left( - \frac{x^2}{4}
...
\makeSubAnswer{Probability density for positive position and time}{problem:qmIproblemSet3:1:c}
...
\end{equation}
%
\makeSubAnswer{Physical meaning}{problem:qmIproblemSet3:1:d}
%
